    ...
    <header className="bg-white/90 backdrop-blur sticky top-0 z-50 border-b">
      <div className="container-max flex items-center justify-between py-4">
        ...
        <nav className={`hidden md:flex gap-6 items-center text-sm`}>
          ...
          <Link href="/contact" className="px-3 py-2 rounded-md bg-navy text-white">Contact</Link>
        </nav>
        ...
        >
          <svg width="28" height="28" viewBox="0 0 24 24"><path d="M3 6h18M3 12h18M3 18h18" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </button>
      </div>
      ...
      {open && (
        <div className="md:hidden bg-white border-t">
          <div className="container-max flex flex-col py-4 gap-2">
            ...
            <Link href="/contact" onClick={()=>setOpen(false)} className="px-3 py-2 rounded-md bg-navy text-white inline-block">Contact</Link>
          </div>
        </div>
      )}
    </header>
